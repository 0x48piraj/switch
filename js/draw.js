var renderer = function() {
	...
	var renderText = function(timeleft, deaths, level, tip) {
		hud.innerHTML = "Timer: " + timeleft + "s | " + deaths + " Lives " + " | Level " + (level+1) + " / " + levels.length; //+ " <sup><a style='font-size: 12px; text-decoration: none;' href='#"+(level+1)+"'>(link)</a></sup>";
